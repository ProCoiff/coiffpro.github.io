...
async function loadSalonData() {
  ...
  if(salon.config_json){try{var cfg=typeof salon.config_json==="string"?JSON.parse(salon.config_json):salon.config_json;if(cfg.slot)SLOT=cfg.slot;if(cfg.slot_h)SLOT_H=cfg.slot_h;if(cfg.fidconf)window.FIDCONF=cfg.fidconf;if(cfg.pay_active)window.PAY_ACTIVE=cfg.pay_active;if(cfg.fond_caisse!==undefined){if(!window.CAISSE_DATA)window.CAISSE_DATA={};window.CAISSE_DATA.fond=cfg.fond_caisse;}if(!window.CAISSE_DATA)window.CAISSE_DATA={fond:200};if(typeof cfg.coffreEsp==="number")window.CAISSE_DATA.coffreEsp=cfg.coffreEsp;if(typeof cfg.coffreChq==="number")window.CAISSE_DATA.coffreChq=cfg.coffreChq;if(Array.isArray(cfg.misesAuCoffre))window.CAISSE_DATA.misesAuCoffre=cfg.misesAuCoffre;if(Array.isArray(cfg.mouvements))window.CAISSE_DATA.mouvements=cfg.mouvements;if(Array.isArray(cfg.remisesBanque))window.CAISSE_DATA.remisesBanque=cfg.remisesBanque;if(Array.isArray(cfg.retraits))window.CAISSE_DATA.retraits=cfg.retraits;if(Array.isArray(cfg.pieces))window.CAISSE_DATA.pieces=cfg.pieces;if(cfg.sms_config)window.SMS_CONFIG=cfg.sms_config;if(cfg.prodcolors){window.PRODCOLORS=cfg.prodcolors;try{localStorage.setItem("_lx_prodcolors",JSON.stringify(cfg.prodcolors));}catch(e){}}if(cfg.svccolors){window.SVCCOLORS=cfg.svccolors;try{localStorage.setItem("_lx_svccolors",JSON.stringify(cfg.svccolors));}catch(e){}}if(cfg.validite_devis)SALON_CONFIG.validiteDevis=Number(cfg.validite_devis);if(Array.isArray(cfg.categories))window._cfgCategories=cfg.categories.slice();if(Array.isArray(cfg.categories_services))window._cfgCatsSvc=cfg.categories_services.slice();if(Array.isArray(cfg.categories_forfaits))window._cfgCatsForf=cfg.categories_forfaits.slice();if(typeof cfg.facebookUrl==="string")SALON_CONFIG.facebookUrl=cfg.facebookUrl;if(typeof cfg.instagramUrl==="string")SALON_CONFIG.instagramUrl=cfg.instagramUrl;if(typeof cfg.tiktokUrl==="string")SALON_CONFIG.tiktokUrl=cfg.tiktokUrl;}catch(e){}}
